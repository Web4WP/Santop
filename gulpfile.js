...
const video = require('./gulp/copyVideo');

module.exports.build = gulp.series(del, fonts, pug2Html, scss2Css, imgMin, svgSprite, copyCSS, video, copyJS);
module.exports.start = gulp.series(del, fonts,  pug2Html, scss2Css, imgMin, svgSprite, copyCSS, copyJS, video, serve);
